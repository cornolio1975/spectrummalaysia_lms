...
import { getTrainerProfiles } from "@/app/actions/trainer_tabs";

export const metadata = {
  title: "Trainer Profiles | SpectrumMY LMS",
};
...
export default async function Page() {
  ...
  const { data, error } = await getTrainerProfiles();

  return (
    <div className="p-6 max-w-[1400px] mx-auto">
      <div className="page-header mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold mb-2">Trainer Profiles</h1>
          <p className="text-gray-500">Manage and view trainer profiles</p>
        </div>
