...
export const metadata = {
  title: "Trainer Certificates | SpectrumMY LMS",
};
  ...
  return (
    <div className="p-6 max-w-[1400px] mx-auto">
      <div className="page-header mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold mb-2">Trainer Certificates</h1>
          <p className="text-gray-500">Manage trainer certificates</p>
        </div>
