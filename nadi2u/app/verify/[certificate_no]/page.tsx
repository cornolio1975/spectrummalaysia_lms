...
export async function generateMetadata({ params }: { params: { certificate_no: string } }): Promise<Metadata> {
  ...
  return {
    title: `Verify Certificate ${certificate_no} | NADI2U`,
    description: "Verify the authenticity of a NADI2U certificate."
  };
}
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Official verification portal for NADI2U LMS</p>
        </div>
        ...
        <div className={`bg-white rounded-xl shadow-lg overflow-hidden border-t-8 ${isRevoked ? 'border-red-500' : 'border-green-500'}`}>
              ...
              <div className="flex-1">
                ...
                {!isRevoked && (
                  <p className="text-sm text-gray-500 ml-13 mt-1">
                    This certificate is official and recognized by NADI2U.
                  </p>
                )}
              </div>
          ...
          <div className="bg-gray-50 px-8 py-4 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <p>Verified securely via NADI2U Blockchain / Database</p>
