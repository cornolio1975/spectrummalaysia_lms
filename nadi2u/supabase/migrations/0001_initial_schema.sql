-- ============================================================
-- NADI2U Programme & Learning Management System
...
CREATE TABLE certificate_templates (
  ...
  template_css    TEXT,
  issuer_name     TEXT NOT NULL DEFAULT 'NADI2U Programme',
  issuer_logo     TEXT,
  signature_name  TEXT,
...
CREATE TABLE certificates (
  id               UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  certificate_no   TEXT NOT NULL UNIQUE,    -- e.g. NADI2U-2026-000001
...
BEGIN
  IF NEW.certificate_no IS NULL OR NEW.certificate_no = '' THEN
    NEW.certificate_no := 'NADI2U-' || TO_CHAR(NOW(), 'YYYY') || '-' || LPAD(NEXTVAL('cert_seq')::TEXT, 6, '0');
  END IF;
  RETURN NEW;
END;
$$;
...
INSERT INTO system_settings (setting_key, setting_value, setting_type, category, description) VALUES
  ('org_name',            'NADI2U Programme',                     'string',  'organization',  'Organisation display name'),
  ('org_full_name',       'NADI2U Programme & Learning Management System', 'string', 'organization', 'Full organisation name'),
  ('org_country',         'Malaysia',                             'string',  'organization',  'Country'),
  ('cert_issuer',         'NADI2U Programme',                     'string',  'certificate',   'Default certificate issuer name'),
