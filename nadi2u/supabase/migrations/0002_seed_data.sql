...
INSERT INTO nadi_sites (id, nadi_code, nadi_name, state_id, address, district, postcode, contact_person, contact_phone, contact_email) VALUES
  ('20000000-0000-0000-0000-000000000001', 'NADI-SGR-001', 'NADI Petaling Jaya',         '10000000-0000-0000-0000-000000000010', 'No. 1 Jalan PJ Utama, Petaling Jaya', 'Petaling', '47810', 'Nor Azlin binti Hassan',    '+60 3-7950 1234', 'nadi.pj@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000002', 'NADI-SGR-002', 'NADI Shah Alam',             '10000000-0000-0000-0000-000000000010', 'No. 5 Persiaran PKNS, Shah Alam',    'Petaling', '40150', 'Ahmad Fauzi bin Ismail',    '+60 3-5510 2345', 'nadi.sha@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000003', 'NADI-SGR-003', 'NADI Klang',                 '10000000-0000-0000-0000-000000000010', 'Jalan Meru, Klang',                  'Klang',    '41050', 'Rosnah binti Abdul Razak',  '+60 3-3371 3456', 'nadi.klang@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000004', 'NADI-JHR-001', 'NADI Johor Bahru',           '10000000-0000-0000-0000-000000000001', 'No. 10 Jalan Stulang, Johor Bahru', 'Johor Bahru', '80300', 'Mohd Hafiz bin Othman',  '+60 7-226 4567', 'nadi.jb@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000005', 'NADI-JHR-002', 'NADI Batu Pahat',            '10000000-0000-0000-0000-000000000001', 'Jalan Kluang, Batu Pahat',           'Batu Pahat','83000', 'Siti Nurhaliza binti Zain', '+60 7-431 5678', 'nadi.bp@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000006', 'NADI-PNG-001', 'NADI Georgetown',            '10000000-0000-0000-0000-000000000007', 'No. 3 Jalan Magazine, Georgetown',  'Timur Laut','10300', 'Lee Mei Ling',             '+60 4-261 6789', 'nadi.gt@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000007', 'NADI-PNG-002', 'NADI Bukit Mertajam',        '10000000-0000-0000-0000-000000000007', 'Jalan Kulim, Bukit Mertajam',       'Seberang Perai','14000','Tan Ah Kow',            '+60 4-530 7890', 'nadi.bm@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000008', 'NADI-PRK-001', 'NADI Ipoh',                  '10000000-0000-0000-0000-000000000008', 'No. 20 Jalan Raja, Ipoh',           'Kinta',    '30000', 'Rajan a/l Krishnan',        '+60 5-241 8901', 'nadi.ipoh@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000009', 'NADI-SBH-001', 'NADI Kota Kinabalu',         '10000000-0000-0000-0000-000000000012', 'Jalan Tuaran, Kota Kinabalu',       'Kota Belud','88450', 'Baharudin bin Mohamad',    '+60 88-421 9012', 'nadi.kk@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000010', 'NADI-SBH-002', 'NADI Sandakan',              '10000000-0000-0000-0000-000000000012', 'Jalan Dua, Sandakan',               'Sandakan', '90000', 'Junaidi bin Sulang',        '+60 89-213 0123', 'nadi.sdk@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000011', 'NADI-SWK-001', 'NADI Kuching',               '10000000-0000-0000-0000-000000000013', 'Jalan Datuk Abang, Kuching',        'Kuching',  '93450', 'Florence Anak Jinggut',     '+60 82-231 1234', 'nadi.kch@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000012', 'NADI-SWK-002', 'NADI Miri',                  '10000000-0000-0000-0000-000000000013', 'Jalan Melayu, Miri',                'Miri',     '98000', 'Peter Bing Tong',           '+60 85-412 2345', 'nadi.miri@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000013', 'NADI-KTN-001', 'NADI Kota Bharu',            '10000000-0000-0000-0000-000000000003', 'Jalan Hamzah, Kota Bharu',          'Kota Bharu','15050','Zulaikha binti Yusof',     '+60 9-744 3456', 'nadi.kb@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000014', 'NADI-TRG-001', 'NADI Kuala Terengganu',      '10000000-0000-0000-0000-000000000011', 'Jalan Sultan Ismail, Kuala Terengganu','Kuala Terengganu','20200','Wan Nor Atiqah','+60 9-623 4567', 'nadi.kt@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000015', 'NADI-MLK-001', 'NADI Melaka Tengah',         '10000000-0000-0000-0000-000000000004', 'Jalan Munshi Abdullah, Melaka',     'Melaka Tengah','75100','Cheah Boon Lim',        '+60 6-282 5678', 'nadi.mlk@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000016', 'NADI-NSN-001', 'NADI Seremban',              '10000000-0000-0000-0000-000000000005', 'Jalan Sungai Ujong, Seremban',      'Seremban', '70200', 'Krishnamurthy a/l Pillai',  '+60 6-763 6789', 'nadi.srb@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000017', 'NADI-PHG-001', 'NADI Kuantan',               '10000000-0000-0000-0000-000000000006', 'Jalan Teluk Sisek, Kuantan',        'Kuantan',  '25000', 'Norhasliza binti Mahmud',   '+60 9-513 7890', 'nadi.kuantan@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000018', 'NADI-KDH-001', 'NADI Alor Setar',            '10000000-0000-0000-0000-000000000002', 'Jalan Pekan Melayu, Alor Setar',    'Kota Setar','05050','Anisah binti Abdullah',    '+60 4-731 8901', 'nadi.as@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000019', 'NADI-SGR-004', 'NADI Subang Jaya',           '10000000-0000-0000-0000-000000000010', 'SS 15, Subang Jaya',                'Petaling', '47500', 'Lim Swee Keng',             '+60 3-5636 9012', 'nadi.subang@nadi2u.gov.my'),
  ('20000000-0000-0000-0000-000000000020', 'NADI-KUL-001', 'NADI Kuala Lumpur Pusat',    '10000000-0000-0000-0000-000000000014', 'Jalan Raja Laut, Kuala Lumpur',     'KL Pusat', '50350', 'Muhd Fadhilah bin Zulkifli','+60 3-2690 0123', 'nadi.klc@nadi2u.gov.my');

-- ─── TRAINERS ──────────────────────────────────────────────────────────────

INSERT INTO trainers (id, name, email, phone, specialization, organization, status) VALUES
  ('30000000-0000-0000-0000-000000000001', 'Dr. Azman bin Ibrahim',       'azman.ibrahim@nadi2u.gov.my',  '+60 12-301 2345', 'Digital Education & LMS',  'NADI2U Training Division', 'active'),
  ('30000000-0000-0000-0000-000000000002', 'Puan Siti Rohani binti Yusuf','siti.rohani@nadi2u.gov.my',    '+60 12-302 3456', 'STEM Education',            'NADI2U Training Division', 'active'),
  ('30000000-0000-0000-0000-000000000003', 'Encik Rizal bin Ramli',       'rizal.ramli@nadi2u.gov.my',    '+60 12-303 4567', 'Entrepreneurship & SME',   'NADI2U Training Division', 'active'),
  ('30000000-0000-0000-0000-000000000004', 'Dr. Lim Chee Wai',           'lim.cheewai@nadi2u.gov.my',    '+60 12-304 5678', 'Artificial Intelligence',  'NADI2U Training Division', 'active'),
  ('30000000-0000-0000-0000-000000000005', 'Puan Fauziah binti Mohd Noor','fauziah.noor@nadi2u.gov.my',   '+60 12-305 6789', 'Digital Marketing',        'NADI2U Training Division', 'active');
...
INSERT INTO certificate_templates (id, programme_id, template_name, issuer_name, signature_name, is_default) VALUES
  ('90000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000001', 'eKelas Pelajar Standard Certificate',    'NADI2U Programme', 'Pengarah NADI2U', TRUE),
  ('90000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000002', 'eKelas Usahawan Standard Certificate',  'NADI2U Programme', 'Pengarah NADI2U', TRUE),
  ('90000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000003', 'AI WIRA Standard Certificate',          'NADI2U Programme', 'Pengarah NADI2U', TRUE);
